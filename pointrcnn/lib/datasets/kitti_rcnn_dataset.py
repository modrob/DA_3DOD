...
class KittiRCNNDataset(KittiDataset):
    def __init__(self, root_dir, npoints=16384, split='train', classes='Car', mode='TRAIN', random_select=True,
                 ...
                 subsample=-1, shuffle_subsample=False, self_training='label_2',self_training_textfile=None):
        super().__init__(root_dir=root_dir, split=split, subsample=subsample, shuffle_subsample=shuffle_subsample, self_training=self_training,self_training_textfile=self_training_textfile)
        if classes == 'Car':
