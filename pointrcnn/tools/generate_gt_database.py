...
parser.add_argument("--self_training", type=str, default='label_2')
parser.add_argument("--self_training_textfile", type=str, default=None)

args = parser.parse_args()


class GTDatabaseGenerator(KittiDataset):
    def __init__(self, root_dir, split='train', classes=args.class_name, subsample=-1, shuffle_subsample=None, self_training=args.self_training, self_training_textfile=args.self_training_textfile):
        super().__init__(root_dir, split=split, subsample=subsample, shuffle_subsample=shuffle_subsample, self_training=args.self_training, self_training_textfile=args.self_training_textfile)
...
if __name__ == '__main__':
    dataset = GTDatabaseGenerator(root_dir=args.root, split=args.split, subsample=args.subsample,
                                  shuffle_subsample=args.shuffle_subsample)
